  ...
  <div>
    ...
    <div>
      <div class="info_show">
        <div class="info_up">
          <img
            :src="comContent.poster"
          />
          <div>
            <div class="who">{{comContent.properName}}</div>
            <div class="score">
              <span>{{comContent.rank}}</span>
              <ul class="star">
                <li>
                  <img src="//static.piaoniu.com/nuxt-static/img/starYellow.b0a4b5a.png" alt />
                </li>
                <li>
                  <img src="//static.piaoniu.com/nuxt-static/img/starYellow.b0a4b5a.png" alt />
                </li>
            ...
            <div class="price">
              <div>
                <span>{{comContent.lowPrice}}</span>
                <span>元起</span>
              </div>
              <span class="buy">已有{{comContent.venueId}}人购买👑</span>
            </div>
          </div>
        </div>
      ...
      <div class="pre_sale">
        <div>
          <img src="http://static.piaoniu.com/nuxt-static/img/icon-presale.3e7d5ce.png" alt />
          <p>{{comContent.timeRange}}</p>
        </div>
        <div>查看详情</div>
      </div>

      <!-- 时间 -->
      <div class="time">{{comContent.timeRange}}</div>

      <!-- 地址 -->
      <div class="addr">
        <p>{{comContent.venueName}}</p>
        <img src="http://static.piaoniu.com/nuxt-static/img/icon-park2.c5fced0.png" alt />
      </div>

      <!-- 购票须知 -->
      <div class="mustKnow">
        <p>购票须知</p>
        <img src="http://static.piaoniu.com/nuxt-static/img/arr-right.1655c6a.png" alt />
      </div>
      ...
      <div class="starDetail">
        ...
        <div class="starPer">
          ...
          <div>
            <div>
              <img
                src="http://img.piaoniu.com/user/1901722/avatar/1530421827315.jpg/7f639d832865e5f8ca2715f2ae666fba16cb867d.jpg"
                alt
              />
              <img
                src="http://img.piaoniu.com/user/1901722/avatar/1530421827315.jpg/7f639d832865e5f8ca2715f2ae666fba16cb867d.jpg"
            ...
            <div>
              <img
                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAAXNSR0IArs4c6QAAADxJREFUOBFjZMABvPtf/0eW2looyojMh7GZYAxy6VEDGBgY0UOb1MAcBoGINXWBwgE9bEZTIu7UQXE6AACcpgriqX9F/wAAAABJRU5ErkJggg=="
                alt
              />
              <span>关注</span>
            </div>
    ...
    <div class="onSite">
      ...
      <div class="siteImg">
        <li>
          <img
            src="https://img.piaoniu.com/review/548cb5dff80cb5a26331b499ce4eeb41c640e436.jpg?imageView2/2/w/300/h/300/format/jpg"
          />
        </li>
        <li>
          <img
    ...
    <!-- 演出简介 -->
    <div class="show_brief">
      <div class="brief">演出简介</div>
      <div class="brief_text">
        <p>情歌王子传唱经典、跟随曾经熟悉的声音，回味人生的某一段时光，以及许多深藏在内心深处的故事。</p>
        <img
          src="https://img.piaoniu.com/upload-ueditor-image-20190125-1548406783541020150.jpg"
          alt
        />
        <p>张信哲中国台湾**男歌手，擅长抒情慢歌。在20世纪90年代与叱咤华语乐坛的“四大天王”齐名。凭**张专辑《说谎》一炮而红，一年内连续推出三张唱片。服役退伍后重返歌坛，演唱《难以抗拒你容颜》依旧畅销。《回来》、《不做你的爱人》、《找钥匙》、《爱就一个字》、《信仰》等歌曲一首接一首地占据排行榜榜首；凭借着《宽容》专辑拿下金曲奖等多个颁奖典礼的**男歌手奖，主打歌为李宗盛写的《爱如潮水》，成功将张信哲推上巅峰。</p>
      </div>
      <div class="more">
        <p>展开更多</p>
        <img src="http://static.piaoniu.com/nuxt-static/img/blueArrowDown.9e945aa.png" alt />
      </div>
    </div>
    ...
    <div class="rel">
      ...
      <div class="relative">
        <li class="box">
          <img
            src="https://img.piaoniu.com/poster/3abd82ea4a0adb225a0ed6227ca78a809b98de9e.jpg?imageView2/2/w/164/h/220/format/jpg/q/60"
          />
          <div class="info">
            <div class="title-line">[深圳]廖昌永独唱音乐会系列之《难忘的旋律》</div>
            <div class="time-address">
              <span class="Ttime">2019.12.24 20:00</span>
              <span class="split">|</span>
              <span class="address">深圳大剧院大剧场</span>
            </div>
            <div class="no-rank">暂无评分</div>
            <div class="price-wrap">
              <span class="_price">904</span>
    ...
    <div class="footerr">
      ...
      <div class="lipei">
        <div>
          <img src="http://static.piaoniu.com/nuxt-static/img/icon-zhenpiao2.6bf8fbd.png" alt />
          <p>无票赔付</p>
        </div>
        <div>
          <img src="http://static.piaoniu.com/nuxt-static/img/icon-zhenpiao2.6bf8fbd.png" alt />
...
<script>
import {detailsData,personsData} from "@api/home";
export default {
  name: "Details",
  props:["id","properName"],
  data() {
...
.pre_sale div:nth-child(1) {
  display: flex;
}
.pre_sale div:nth-child(1) img {
  width: 0.18rem;
  height: 0.16rem;
  margin-right: 0.05rem;
}
.pre_sale div:nth-child(2) {
  font-size: 0.11rem;
}
...
.starWho p:nth-child(1) {
  font-size: 0.15rem;
  color: #333333;
}
.starWho p:nth-child(2) {
  font-size: 0.12rem;
  color: #888888;
}
.starDetail {
...
.starPer div:nth-child(2) {
  -margin-left: 0.11rem;
}
.starPer div:nth-child(2) span:nth-child(1) {
  font-size: 14px;
  font-weight: 700;
  color: #ffb200;
}
...
.starPer div:nth-child(3) img {
  width: 0.08rem;
  height: 0.08rem;
  margin-right: 0.05rem;
}
.starPer div:nth-child(3) span {
  color: #4b8feb;
  font-size: 0.12rem;
}
...
.siteImg li:nth-child(7) span {
  white-space: nowrap;
}
.siteImg li:nth-child(7) div {
  width: 100%;
  height: 1px;
  background-color: #d0d1d4;
}
.siteImg li:nth-child(7) span:nth-of-type(1) {
  font-size: 0.15rem;
  margin-bottom: 0.05rem;
}
.siteImg li:nth-child(7) span:nth-of-type(2) {
  font-size: 0.14rem;
  margin-top: 0.04rem;
}
