  ...
  <div class="page">
    ...
    <div class="home-entries">
      <ul class="main-categories">
        <li class="entry" v-for="item in iconImg" :key="item.id">
    ...
    <div class="hot-activities">
      <div class="activity-floor">
        ...
        <div class="activities">
          <ul class="wrap">
            <li class="activity-floor-item">
              <div class="item-img">
                <img
                  src="https://img.piaoniu.com/poster/3d1e70d1aa64af661c8a077b09520668bfe5bf75.jpg?imageView2/2/w/220/h/164/format/jpg/q/60"
                />
              </div>
              <div class="name">周传雄深圳演唱会</div>
              <div class="price">
                <span class="price-num">￥504</span>
...
.hot-activities .activity-floor .activities .wrap .activity-floor-item .item-img{
    width:1.02rem;height:1.37rem;
}
.hot-activities .activity-floor .activities .wrap .activity-floor-item .item-img img{
    width:1.02rem;height:1.37rem;
}
...
.hot-activities .activity-floor .activities .wrap .activity-floor-item  .price .price-num{
    color: #ff2661;
    font-size: 0.12rem;
}
.hot-activities .activity-floor .activities .wrap .activity-floor-item  .price .price-asc{
    height:0.14rem;
    font-size: 0.12rem;
    margin-left:0.01rem;
    transform: scale(.8);
...
.guess-like-wrap .box .info .price-wrap{
